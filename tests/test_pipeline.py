...
class PipelineTests(unittest.TestCase):
    ...
    def test_empty_build_is_an_explicit_preview(self):
        ...
        self.assertIn("brand__mark", html)
        ...
        template = Path("src/ksr_index/templates/index.html.j2").read_text(encoding="utf-8")
        self.assertIn("{% if loop.index > 20 %} hidden{% endif %}", template)
        self.assertNotIn("↗", template)
        self.assertNotIn("↗", html)
        self.assertIn("text-arrow", html)
